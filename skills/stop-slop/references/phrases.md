...
Cut empty intensifiers, softeners, and filler hedges — adverbs that add emphasis without information. Keep adverbs that carry time, degree, frequency, or scope ("only", "weekly", "twice"). Do not classify a word by its -ly ending alone.
