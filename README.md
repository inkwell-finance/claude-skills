...
| [worktree-gc](skills/worktree-gc/) | `/worktree-gc` | Worktree sprawl after agent runs | Inventory → classify → push unpushed branches → prune → report; never loses uncommitted work |
